/**
 * M13 t13a GLTF-pipeline verification harness (not shipped; run manually / in CI).
 *
 * Parses the baked test model (`client/public/models/character.glb`) HEADLESSLY
...
const GLB = join(CLIENT, 'public', 'models', 'character.glb');
...
// 2. Every EntityState clip is present.
