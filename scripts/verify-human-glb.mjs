/**
 * M13 t13b HUMAN GLTF verification harness (not shipped; run manually / in CI).
 *
 * Parses the baked human model (`client/public/models/human.glb`) HEADLESSLY
 * with the SAME loader + clone + AnimationMixer the client uses, asserting the
 * exact contract `GltfCharacter` depends on:
 ...
 *     claw/stun/down) and nothing extra,
...
const GLB = join(CLIENT, 'public', 'models', 'human.glb');
...
// 2. Every EntityState clip is present, none extra.
